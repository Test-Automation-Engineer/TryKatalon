...
WebUI.sendKeys(findTestObject('Page_CURA Healthcare Service/input_password'), Keys.chord(Keys.ENTER))
...
WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/a_Go to Homepage'), 0)
